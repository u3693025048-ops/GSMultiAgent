...
# NOTE: optimizers package removed (legacy). This file is not used in the
# main CLI flow (cli_agent.py uses optimization_workflow.py instead).
# Stub classes to prevent NameError at import time.
class BaseOptimizer:
    pass
